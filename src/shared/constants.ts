import type { BuildingDefinition, RefiningRecipe } from "./types";
...
export const ISO_WORLD_WIDTH = (GRID_WIDTH + GRID_HEIGHT) * (ISO_TILE_WIDTH / 2);
export const ISO_WORLD_HEIGHT = (GRID_WIDTH + GRID_HEIGHT) * (ISO_TILE_HEIGHT / 2) + ISO_TILE_DEPTH;
export const AGENT_SPRITE_WIDTH = 32;
export const AGENT_SPRITE_HEIGHT = 40;

// --- Plots (simplified: single tile claim system) ---
